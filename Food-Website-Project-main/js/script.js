...
document.querySelector('#login-btn').onclick = () => {
    ...
    cart.classList.remove('active');
    navbar.classList.remove('active');
    // const scriptURL = 'https://script.google.com/macros/s/AKfycbw5m9OzBgTLE63OV4B6WdfIWGEtpmjUhGBmi8i7yEYFbZObKxv1KfS5F32TLp8cHTCg/exec'
//   const form = document.forms['form data']

//   form.addEventListener('submit', e => {
//     e.preventDefault()
//     fetch(scriptURL, { method: 'POST', body: new FormData(form)})
//       .then(response => console.log('You Login Successfully!', response))
